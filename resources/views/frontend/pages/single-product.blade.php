	                    ...
	                    <div class="col-12 col-lg-9">
	                        <div class="module__content">
	                            ...
	                            <div class="related__products">
	                                <h2 class="related__products--title">Những sản phẩm liên quan</h2>
	                                <div class="related__content">
	                                    <div class="product__group">
	                                    	@foreach($product_same_category as $item)
	                                        <div class="product">
	                                            <a href="{{route('home.single.product',['slug'=>$item->slug])}}" class="product__box">
	                                                <div class="avata">
	                                                    <div class="frame">
	...
	@section('script')
		<script>
		    $(document).ready(function () {
			    ...
			    $('a[href="{{request()->root()}}/san-pham"]').parents('li').addClass('active');
			});
		</script>
	@endsection
@endsection