...
@section('main')
	...
	<main id="main">
	    @if(!empty($cate->meta_banner))
	    <section class="section__banner">
	        <div class="frame cus__frame">
	            <img class="frame--image" src="{{url('/')}}/{{json_decode($cate->meta_banner)->image}}" alt="{{json_decode($cate->meta_banner)->title}}" />
	        </div>
	        @if(!empty($cate->name))
	        <div class="container">
	                        ...
	                        <div class="module__content">
	                            <ul class="sideba">
	                                ...
	                                <li class="sideba__item @if($cate->id == $item->id) active @endif">
	                                    <a class="sideba__item--link" href="{{route('home.archive.product',['slug'=>$item->slug])}}" title="{{@$item->name}}"> {{@$item->name}} </a>
	                                </li>
	                                @endforeach
	                            </ul>
	                        </div>
