...
<span id="sample-permalink">
	<a class="permalink" target="_blank" href="{{ asset('linh-kien/'.$data->slug ) }}">
    	<span class="default-slug">
    		{{ asset('linh-kien') }}/<span id="editable-post-name">{{ $data->slug }}</span>
    	</span>
	</a>
</span>
...
<input type="hidden" id="baseUrl" value="{{ asset('linh-kien') }}">
