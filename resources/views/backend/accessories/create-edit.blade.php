		                    	...
		                    	<div class="row">
		                    		...
		                    		<div class="col-sm-12">
										...
										@if(isUpdate(@$module['action']))
			                                ...
			                                <div class="form-group" id="edit-slug-box">
			                                    ...
			                                    @include('backend.accessories.permalink')
		                    		...
		                    		<div class="col-sm-12">
		                    			...
		                    			<div class="form-group">
		                    				...
		                    				<label for="">Chi tiết linh kiện</label>
		                    ...
		                    <div class="tab-pane @if(session('active_tab')=='thu-vien-anh') active @endif" id="gallery">
		                    	...
		                    	<div class="row">
			                        ...
			                        <div class="col-sm-12 image">
			                        	...
			                        	<label for="">Hình ảnh chi tiết linh kiện</label><br>
				...
				<div class="col-sm-3">
					...
					<div class="box box-success">
		                ...
		                <div class="box-header with-border">
		                    ...
		                    <h3 class="box-title">Đăng linh kiện</h3>
		                ...
		                <div class="box-body">
		                    ...
		                    <div class="form-group text-right">
		                        ...
		                        <button type="submit" class="btn btn-primary"><i class="fa fa-save"></i> Lưu lại linh kiện</button>
		            ...
		            <div class="box box-success category-box">
		                ...
		                <div class="box-header with-border">
		                    ...
		                    <h3 class="box-title">Danh mục linh kiện </h3>
		            ...
		            <div class="box box-success">
		                ...
		                <div class="box-header with-border">
		                    ...
		                    <h3 class="box-title">Ảnh linh kiện</h3>
		            ...
		            <div class="box box-success">
		                ...
		                <div class="box-header with-border">
		                    ...
		                    <h3 class="box-title">Banner chi tiết linh kiện</h3>
		...
		jQuery(document).ready(function($) {
			...
			$('#btn-ok').click(function(event) {
		        ...
		        $.ajax({
		        	...
		        	url: '{{ route('accessories.get-slug') }}',
