...
class ContactController extends Controller
{
    ...
    public function getListMailSale(){

        $data = PromotionalNews::orderBy('created_at','DESC')->get();

        return view('backend.contact.mail-sale', compact('data'));
    }

    public function deleteMailSale($id){

        PromotionalNews::destroy($id);
