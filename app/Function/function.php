...
function listCateAccessories($data, $parent_id = 0, $str = '')
    ...
    foreach ($data as $value) {
        ...
        if ($value->parent_id == $parent_id) {
            ...
            echo '<td>
                        ...
                        <a class="text-default" href="' . route('category_accessories.edit', $id) . '" title="Sửa">' . $strName . '</a></br>

                        <a href="' . asset('danh-muc-linh-kien/' . $value->slug) . '" target="_blank"> <i class="fa fa-hand-o-right" aria-hidden="true"></i> Link: ' . asset('danh-muc-linh-kien/' . $value->slug) . ' </a>

                    </td>';

            echo '<td><a class="text-default" href="' . route('category_accessories.edit', $id) . '" title="Sửa"> ' . count($value->get_child_cate()) ?: '_' . ' </a>

                        </td>';

            echo ' <td><a href="' . route('category_accessories.edit', $id) . '" title="Sửa"> <i class="fa fa-pencil fa-fw"></i> Sửa</a> &nbsp; &nbsp; &nbsp;

                                <a href="javascript:;" class="btn-destroy" data-href="' . route('category_accessories.destroy', $id) . '" data-toggle="modal" data-target="#confim">
...

{
    ...
    foreach ($data as $value) {
        ...
        if ($value->parent_id == $parent_id) {
            ...
            echo '<td><a class="text-default" href="' . route('category-post.edit', $id) . '" title="Sửa"> ' . count($value->get_child_cate()) ?: '_' . ' </a>
